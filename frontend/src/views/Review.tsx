...
import { Banner, Card, ProgressBar, SectionLabel, SkeletonList, Tag } from "../components/Primitives";
...
export function Review() {
  ...
  if (!review) return <SkeletonList rows={4} height="h-36" />;
  ...
  return (
    <div className="space-y-3">
      ...
      {review.open_gaps.length > 0 && (
        <Card>
          <SectionLabel>Still Unanswered</SectionLabel>
      ...
      {Object.keys(review.revealed_preference).length > 0 && (
        <Card>
          <SectionLabel>What You Did With the Plan</SectionLabel>
